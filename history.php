...
<!-- Page Header Start -->
	...
	mysql_select_db($db);
			...
			if(mysqli_connect_errno()) {  
				...
				$sql1 = "select * from porder where cust = '$users';";
				...
				{
					echo "<h1 align='center'>'No Order placed yet.'</h1>";
				} 
				else
				{	
					echo "<table border=1 align='center' cellpadding='10' width='70%'>";
					echo "<tr align='center' bgcolor='#000099' style='color:#fff'><th>Order ID</th><th>Item Description</th> <th> Amount</th> <th> Date </th></tr>";
        ...
        <input type="submit" Value="Back" style="padding:10px;  background-color:#000099;  width:200px; font-weight:bold; color:#FFF;">
        </form>
		</div>
        <!--- Summary end -->
