    ...
    <div class="login-page">
      <div class="form">
        ...
        <form class="login-form" method="post" action="connection.php">
          <input type="text" placeholder="username" name="username" pattern="[a-zA-Z'-'\s]*" title="Username must have letters"/>
          <input type="password" placeholder="password" name="password" maxlength="7" minlength="7" />
