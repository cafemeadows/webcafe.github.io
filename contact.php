            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="contact.php" class="nav-item nav-link active">Contact/Reviews</a>
                         <?php session_start();
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="footer-link">
                                    <h2>Quick Links</h2>
                                    <a href="ordermenu.php">Order</a>
                                    <a href="booking.php">Bookings/Menu</a>
                                    <a href="contact.php">Contact Us/Reviews</a>
                                </div>
                            </div>
                        </div>
                    </div>
